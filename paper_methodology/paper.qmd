...
It is also important to define the projected CRS to consider for the geometrical match, to avoid distortions in the distance calculations. For this case study, EPSG:3763 was used, which is the most suitable for Portugal mainland.
...
TCB and Carris Metropolitana were the operators that presented the greatest reduction, with the first having dropped 9.68 p.p. in the number of shapes matched.
