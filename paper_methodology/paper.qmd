...
This analysis will focus on the bus mode and its four operators, a network represented in @fig-aml-shapes-osm, considering the GTFS feeds available for the month of May 2026:
...
> **Notes:** ¹ Considering GTFS filtered for 27/05/2026 (working day) between 08:00 and 09:00.
...
In contrast, TCB and MobiCascais demonstrate tighter spatial bounds, with MobiCascais achieving the lowest mean route length difference (108 ± 363.4 m), reflecting greater geometry consistency at the municipality level.

Interestingly, despite these spatial variances, the discrepancy in the number of stop points remains relatively consistent across all four operators, ranging between a mean of 25.5 and 35.2 stops.
