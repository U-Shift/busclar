...
```{r MapResults, echo=FALSE, eval=TRUE, fig.cap="Road segments with higher bus frequency, in Lisbon, at 8 am. The larger and yellowish lines represent the road segments with higher hourly bus frequency. Carto basemap.", fig.link="http://www.rosafelix.bike/transit/carris_cm_8h.html"}
# include figure
