...
All the R and packages' versions used are listed in the `renv.lock` file.
For this article, we used `GTFShift` version v0.7.

Please refer to the assets available at [release version 0.8](https://github.com/U-Shift/busclar/releases/tag/0.8) [@busclar0825], to get the data and the results from this paper, for instance the used GTFS files, as they change periodically.
