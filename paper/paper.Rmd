...
This paper focuses on identifying hourly bus frequency for each road segment in urban areas, using General Transit Feed Specification (GTFS) data, which is widely available from many transit agencies.
